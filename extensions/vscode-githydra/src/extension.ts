...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('githydra.runCustom', (cmd: string) => {
            runGitHydraCommand(cmd);
        })
    );
}

function runGitHydraCommand(args: string) {
...
class GitHydraItem extends vscode.TreeItem {
    constructor(
        ...
        public readonly iconName?: string | { command: string, title: string, arguments?: any[] },
        public readonly commandOrChildren?: vscode.Command | GitHydraItem[]
    ) {
